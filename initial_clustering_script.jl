...
@time for j in 1:365
    cluster = kmeans(data1, j, maxiter=500, display=:final);
    ...
    if (j==12)
        ...
        savefig("C:\\Users\\lucas\\Documents\\ArcGIS\\Projects\\LFranke_WISPO_Proj\\Risk_DataTables\\Clustering Stats\\Cluster12\\date_vs_risk_kmeans.png");
    end
end
